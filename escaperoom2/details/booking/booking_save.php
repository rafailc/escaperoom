...
$time=$_POST['time'] ?? '';
   ...
   $sql_query = "INSERT INTO `reservations` (`room`, `username`,`firstname`, `lastname`, `city`,`date`,`time`,`people`,`phone`,`terms`)";
$sql_query .= " VALUES ('{$room}','{$username}','{$firstname}', '{$lastname}', '{$city}', '{$date}', '{$time}','{$people}', '{$phone}', '{$terms}' )";
...
<body>
  <div class="success-wrap">
    <div class="success-box">
      <p class="success-title"> Η κράτηση ολοκληρώθηκε!</p>
      <p class="success-text">Η κράτησή σας καταχωρήθηκε επιτυχώς.</p>
    </div>

    <a class="back-btn" href="../../home.html">← Πίσω στην αρχική</a>
  </div>
</body>
</html>
<?php
