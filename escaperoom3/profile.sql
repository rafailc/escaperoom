...
-- Χρόνος δημιουργίας: 11 Ιαν 2026 στις 18:26:19
...
INSERT INTO `reservations` (`room`, `username`, `firstname`, `lastname`, `city`, `date`, `time`, `people`, `phone`, `terms`) VALUES
('Haunted House', 'rafa', 'rafa', 'rafa', 'serres', '2026-01-09', '20:47:00', 12, '123454522', 1);
...
(4, 'Terminal Care', '2-9', 20, '80mins', 'Horror', 'hard', 'Asylum.jpg', 'Το σύστημα υποστήριξης της κλινικής καταρρέει. Έχετε 80 λεπτά πριν κλείσει το σύστημα εξαερισμού ή —ακόμα χειρότερα— πριν επιστρέψουν οι «Νοσοκόμοι» για να ολοκληρώσουν τον τελευταίο γύρο επισκέψεων.');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `password`, `gender`, `city`, `is_admin`) VALUES
(10, 'admin', 'admin', 'admin', '$2y$10$N.BL3IHJ3QWD1ZZkdu/ZCOdZHa3tBxglAIKSXAj/KTFehCdl4DhuO', 1, 'serres', 1);
